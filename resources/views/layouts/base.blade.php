          ...
          @guest
                            ...
                            <li class="nav-item">
                                @if (Route::has('register'))
                                    <a class="nav-link" style="display: -webkit-inline-box;" href="{{ route('register') }}">{{ __('Registrarse') }}</a>
                                @endif
                            </li>
                        @else
                            <li class="nav-item dropdown">
                                <a style="display: -webkit-inline-box;" id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
