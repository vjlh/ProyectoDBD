...
class TransportesController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!empty($transportesUbicacion)){
            ...
            $transportes_reservados1 =  DB::table('transportes_reservas')->where('fecha_fin','<',$fecha_inicio)
                                                                         ->select('id_transporte')->get();                        
            $transportes_reservados2 =  DB::table('transportes_reservas')->where('fecha_inicio','>',$fecha_fin)
                                                                         ->select('id_transporte')->get();            
            $ids = [];
            $ids_NoDisponibles =[];
            ...
            $transportes_reservados3 = DB::table('transportes_reservas')->whereNotIn('id_transporte',$ids)
                                                                        ->select('id_transporte')->get();
